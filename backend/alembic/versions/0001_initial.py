...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("iata", sa.String(10), nullable=True, index=True),
        sa.Column("icao", sa.String(10), nullable=True, index=True),
    ...
    op.create_table(
        ...
        sa.Column("airline_iata", sa.String(10), nullable=True),
